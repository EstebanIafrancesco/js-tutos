// You have to write a function that takes for input a 8x8 chessboard in the form of a 
// bi-dimensional array of chars (or strings of length 1, depending on the language) and 
// returns a boolean indicating whether the king is in check.
...
// Note : these are actually inverted-color chess Unicode characters because the codewars 
// dark theme makes the white appear black and vice versa. Use the characters shown above.
...
// tests will print a chessboard to show you the problematic cases. Looking like this :
